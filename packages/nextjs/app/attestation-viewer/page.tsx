        ...
        <div className="flex flex-col items-center flex-grow pt-10">
            <div className="px-5">
                <h1 className="text-center mb-8">
                    ...
                    <span className="block text-4xl font-bold">Attestation Viewer</span>
                </h1>
                            ...
                            <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                <div className="mb-4">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        <button onClick={() => handleAuthorAction('changeThreshold')} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                            Change Co-publish Threshold
                                        </button>
                                        <button onClick={() => handleAuthorAction('sign')} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                            Sign
                                        </button>
                                        <button onClick={() => handleAuthorAction('revokeAffiliation')} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                                            Revoke Affiliation
                                        </button>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        <button onClick={() => handleUserAction('like')} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                                            Like/Upvote
                                        </button>
                                        <button onClick={() => handleUserAction('donate')} className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
                                            Donate
                                        </button>
                                    </div>
                                </div>
